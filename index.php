<?
	...
	//}else{
		...
		$sql .= "a.tgl_lahir, b.kode_prodi, b.kode_univ, c.nama_prodi, d.nama_univ ";
		$sql .= "from peserta a ";
		$sql .= "left join result b on a.nomor = b.nomor ";
		$sql .= "left join prodi c on b.kode_prodi = c.kode_prodi ";
		$sql .= "left join univ d on b.kode_univ = d.kode_univ where a.nomor = '".$nomorPeserta."'";
...
//echo $sql;
		...
		if (mysql_num_rows($result) > 0) {
			...
			if($row["isLulus"] == 0){
				...
				echo "Pada Program Studi ".$row["nama_prodi"]." ".$row["nama_univ"]."<br>";
			}
		    }
		} else {
